...
static const char *key_names[KEY__COUNT] = {
	...
	"Scrol lLock", // KEY_SCROLLLOCK,
	"Num Lock",    // KEY_NUMLOCK,
	"Print",       // KEY_PRINT,
	"Pause",       // KEY_PAUSE,
	"Keypad 0",     // KEY_KEYPAD0,
	"Keypad 1",     // KEY_KEYPAD1,
	"Keypad 2",     // KEY_KEYPAD2,
	"Keypad 3",     // KEY_KEYPAD3,
	"Keypad 4",     // KEY_KEYPAD4,
	"Keypad 5",     // KEY_KEYPAD5,
	"Keypad 6",     // KEY_KEYPAD6,
	"Keypad 7",     // KEY_KEYPAD7,
	"Keypad 8",     // KEY_KEYPAD8,
	"Keypad 9",     // KEY_KEYPAD9,
	"Keypad Enter", // KEY_KEYPADENTER,
	"Decimal",      // KEY_DECIMAL,
